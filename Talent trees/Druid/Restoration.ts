...
// Get the Restoration talent tree (index 2)
 const RESTORATION_TALENT_TREE = DRUID_CLASS.TalentTrees.get()[2]
...
// Improved Mark of the Wild - Row 0, Column 0
 const IMPROVED_MARK_OF_THE_WILD = RESTORATION_TALENT_TREE.Talents
...
// Nature's Focus - Row 0, Column 1
 const NATURE_S_FOCUS = RESTORATION_TALENT_TREE.Talents
...
// Furor - Row 0, Column 2
 const FUROR = RESTORATION_TALENT_TREE.Talents
...
// Naturalist - Row 1, Column 0
 const NATURALIST = RESTORATION_TALENT_TREE.Talents
...
// Subtlety - Row 1, Column 1
 const SUBTLETY = RESTORATION_TALENT_TREE.Talents
...
// Natural Shapeshifter - Row 1, Column 2
 const NATURAL_SHAPESHIFTER = RESTORATION_TALENT_TREE.Talents
...
// Intensity - Row 2, Column 0
 const INTENSITY = RESTORATION_TALENT_TREE.Talents
...
// Omen of Clarity - Row 2, Column 1
 const OMEN_OF_CLARITY = RESTORATION_TALENT_TREE.Talents
...
// Master Shapeshifter - Row 2, Column 2
 const MASTER_SHAPESHIFTER = RESTORATION_TALENT_TREE.Talents
...
// Tranquil Spirit - Row 3, Column 1
 const TRANQUIL_SPIRIT = RESTORATION_TALENT_TREE.Talents
...
// Improved Rejuvenation - Row 3, Column 2
 const IMPROVED_REJUVENATION = RESTORATION_TALENT_TREE.Talents
...
// Nature's Swiftness - Row 4, Column 0
 const NATURE_S_SWIFTNESS = RESTORATION_TALENT_TREE.Talents
...
// Gift of Nature - Row 4, Column 1
 const GIFT_OF_NATURE = RESTORATION_TALENT_TREE.Talents
...
// Improved Tranquility - Row 4, Column 3
 const IMPROVED_TRANQUILITY = RESTORATION_TALENT_TREE.Talents
...
// Empowered Touch - Row 5, Column 0
 const EMPOWERED_TOUCH = RESTORATION_TALENT_TREE.Talents
...
// Nature's Bounty - Row 5, Column 2
 const NATURE_S_BOUNTY = RESTORATION_TALENT_TREE.Talents
...
// Living Spirit - Row 6, Column 0
 const LIVING_SPIRIT = RESTORATION_TALENT_TREE.Talents
...
// Swiftmend - Row 6, Column 1
 const SWIFTMEND = RESTORATION_TALENT_TREE.Talents
...
// Natural Perfection - Row 6, Column 2
 const NATURAL_PERFECTION = RESTORATION_TALENT_TREE.Talents
...
// Empowered Rejuvenation - Row 7, Column 1
 const EMPOWERED_REJUVENATION = RESTORATION_TALENT_TREE.Talents
...
// Living Seed - Row 7, Column 2
 const LIVING_SEED = RESTORATION_TALENT_TREE.Talents
...
// Revitalize - Row 8, Column 0
 const REVITALIZE = RESTORATION_TALENT_TREE.Talents
...
// Tree of Life - Row 8, Column 1
 const TREE_OF_LIFE = RESTORATION_TALENT_TREE.Talents
...
// Improved Tree of Life - Row 8, Column 2
 const IMPROVED_TREE_OF_LIFE = RESTORATION_TALENT_TREE.Talents
...
// Improved Barkskin - Row 9, Column 0
 const IMPROVED_BARKSKIN = RESTORATION_TALENT_TREE.Talents
...
// Gift of the Earthmother - Row 9, Column 2
 const GIFT_OF_THE_EARTHMOTHER = RESTORATION_TALENT_TREE.Talents
...
// Wild Growth - Row 10, Column 1
 const WILD_GROWTH = RESTORATION_TALENT_TREE.Talents
