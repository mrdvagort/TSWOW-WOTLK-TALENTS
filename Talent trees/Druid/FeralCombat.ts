...
// Get the Feral Combat talent tree (index 1)
 const FERAL_COMBAT_TALENT_TREE = DRUID_CLASS.TalentTrees.get()[1]
...
// Ferocity - Row 0, Column 1
 const FeralCombat_FEROCITY = FERAL_COMBAT_TALENT_TREE.Talents
...
// Feral Aggression - Row 0, Column 2
 const FERAL_AGGRESSION = FERAL_COMBAT_TALENT_TREE.Talents
...
// Feral Instinct - Row 1, Column 0
 const FERAL_INSTINCT = FERAL_COMBAT_TALENT_TREE.Talents
...
// Savage Fury - Row 1, Column 1
 const SAVAGE_FURY = FERAL_COMBAT_TALENT_TREE.Talents
...
// Thick Hide - Row 1, Column 2
 const THICK_HIDE = FERAL_COMBAT_TALENT_TREE.Talents
    .addGet("default", "FeralCombat_thick-hide")
    .Position.set(1, 2)

THICK_HIDE.Spells.add([16929, 16930, 16931]) // 3 ranks
...
// Feral Swiftness - Row 2, Column 0
 const FERAL_SWIFTNESS = FERAL_COMBAT_TALENT_TREE.Talents
...
// Survival Instincts - Row 2, Column 1
 const SURVIVAL_INSTINCTS = FERAL_COMBAT_TALENT_TREE.Talents
...
// Sharpened Claws - Row 2, Column 2
 const SHARPENED_CLAWS = FERAL_COMBAT_TALENT_TREE.Talents
...
// Shredding Attacks - Row 3, Column 0
 const SHREDDING_ATTACKS = FERAL_COMBAT_TALENT_TREE.Talents
...
// Predatory Strikes - Row 3, Column 1
 const PREDATORY_STRIKES = FERAL_COMBAT_TALENT_TREE.Talents
...
// Primal Fury - Row 3, Column 2
 const PRIMAL_FURY = FERAL_COMBAT_TALENT_TREE.Talents
...
// Primal Precision - Row 3, Column 3
 const PRIMAL_PRECISION = FERAL_COMBAT_TALENT_TREE.Talents
...
// Brutal Impact - Row 4, Column 0
 const BRUTAL_IMPACT = FERAL_COMBAT_TALENT_TREE.Talents
...
// Feral Charge - Row 4, Column 2
 const FERAL_CHARGE = FERAL_COMBAT_TALENT_TREE.Talents
...
// Nurturing Instinct - Row 4, Column 3
 const NURTURING_INSTINCT = FERAL_COMBAT_TALENT_TREE.Talents
...
// Natural Reaction - Row 5, Column 0
 const NATURAL_REACTION = FERAL_COMBAT_TALENT_TREE.Talents
...
// Heart of the Wild - Row 5, Column 1
 const HEART_OF_THE_WILD = FERAL_COMBAT_TALENT_TREE.Talents
...
// Survival of the Fittest - Row 5, Column 2
 const SURVIVAL_OF_THE_FITTEST = FERAL_COMBAT_TALENT_TREE.Talents
...
// Leader of the Pack - Row 6, Column 1
 const LEADER_OF_THE_PACK = FERAL_COMBAT_TALENT_TREE.Talents
...
// Improved Leader of the Pack - Row 6, Column 2
 const IMPROVED_LEADER_OF_THE_PACK = FERAL_COMBAT_TALENT_TREE.Talents
...
// Primal Tenacity - Row 6, Column 3
 const PRIMAL_TENACITY = FERAL_COMBAT_TALENT_TREE.Talents
...
// Protector of the Pack - Row 7, Column 0
 const PROTECTOR_OF_THE_PACK = FERAL_COMBAT_TALENT_TREE.Talents
...
// Predatory Instincts - Row 7, Column 2
 const PREDATORY_INSTINCTS = FERAL_COMBAT_TALENT_TREE.Talents
...
// Infected Wounds - Row 7, Column 3
 const INFECTED_WOUNDS = FERAL_COMBAT_TALENT_TREE.Talents
...
// King of the Jungle - Row 8, Column 0
 const KING_OF_THE_JUNGLE = FERAL_COMBAT_TALENT_TREE.Talents
...
// Mangle - Row 8, Column 1
 const MANGLE = FERAL_COMBAT_TALENT_TREE.Talents
...
// Improved Mangle - Row 8, Column 2
 const IMPROVED_MANGLE = FERAL_COMBAT_TALENT_TREE.Talents
...
// Rend and Tear - Row 9, Column 1
 const REND_AND_TEAR = FERAL_COMBAT_TALENT_TREE.Talents
...
// Primal Gore - Row 9, Column 2
 const PRIMAL_GORE = FERAL_COMBAT_TALENT_TREE.Talents
...
// Berserk - Row 10, Column 1
 const BERSERK = FERAL_COMBAT_TALENT_TREE.Talents
