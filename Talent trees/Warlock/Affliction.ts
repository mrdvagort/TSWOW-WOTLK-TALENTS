...
// Get the Affliction talent tree (index 0)
 const AFFLICTION_TALENT_TREE = WARLOCK_CLASS.TalentTrees.get()[0]
...
// Improved Curse of Agony - Row 0, Column 0
 const IMPROVED_CURSE_OF_AGONY = AFFLICTION_TALENT_TREE.Talents
...
// Suppression - Row 0, Column 1
 const SUPPRESSION = AFFLICTION_TALENT_TREE.Talents
...
// Improved Corruption - Row 0, Column 2
 const IMPROVED_CORRUPTION = AFFLICTION_TALENT_TREE.Talents
...
// Improved Curse of Weakness - Row 1, Column 0
 const IMPROVED_CURSE_OF_WEAKNESS = AFFLICTION_TALENT_TREE.Talents
...
// Improved Drain Soul - Row 1, Column 1
 const IMPROVED_DRAIN_SOUL = AFFLICTION_TALENT_TREE.Talents
...
// Improved Life Tap - Row 1, Column 2
 const IMPROVED_LIFE_TAP = AFFLICTION_TALENT_TREE.Talents
...
// Soul Siphon - Row 1, Column 3
 const SOUL_SIPHON = AFFLICTION_TALENT_TREE.Talents
...
// Improved Fear - Row 2, Column 0
 const IMPROVED_FEAR = AFFLICTION_TALENT_TREE.Talents
...
// Fel Concentration - Row 2, Column 1
 const FEL_CONCENTRATION = AFFLICTION_TALENT_TREE.Talents
...
// Amplify Curse - Row 2, Column 2
 const AMPLIFY_CURSE = AFFLICTION_TALENT_TREE.Talents
...
// Grim Reach - Row 3, Column 0
 const GRIM_REACH = AFFLICTION_TALENT_TREE.Talents
...
// Nightfall - Row 3, Column 1
 const NIGHTFALL = AFFLICTION_TALENT_TREE.Talents
...
// Empowered Corruption - Row 3, Column 3
 const EMPOWERED_CORRUPTION = AFFLICTION_TALENT_TREE.Talents
...
// Shadow Embrace - Row 4, Column 0
 const SHADOW_EMBRACE = AFFLICTION_TALENT_TREE.Talents
...
// Siphon Life - Row 4, Column 1
 const SIPHON_LIFE = AFFLICTION_TALENT_TREE.Talents
...
// Curse of Exhaustion - Row 4, Column 2
 const CURSE_OF_EXHAUSTION = AFFLICTION_TALENT_TREE.Talents
...
// Improved Felhunter - Row 5, Column 0
 const IMPROVED_FELHUNTER = AFFLICTION_TALENT_TREE.Talents
...
// Shadow Mastery - Row 5, Column 1
 const SHADOW_MASTERY = AFFLICTION_TALENT_TREE.Talents
...
// Eradication - Row 6, Column 0
 const ERADICATION = AFFLICTION_TALENT_TREE.Talents
...
// Contagion - Row 6, Column 1
 const CONTAGION = AFFLICTION_TALENT_TREE.Talents
...
// Dark Pact - Row 6, Column 2
 const DARK_PACT = AFFLICTION_TALENT_TREE.Talents
...
// Improved Howl of Terror - Row 7, Column 0
 const IMPROVED_HOWL_OF_TERROR = AFFLICTION_TALENT_TREE.Talents
...
// Malediction - Row 7, Column 2
 const MALEDICTION = AFFLICTION_TALENT_TREE.Talents
...
// Death's Embrace - Row 8, Column 0
 const DEATH_S_EMBRACE = AFFLICTION_TALENT_TREE.Talents
...
// Unstable Affliction - Row 8, Column 1
 const UNSTABLE_AFFLICTION = AFFLICTION_TALENT_TREE.Talents
...
// Pandemic - Row 8, Column 2
 const PANDEMIC = AFFLICTION_TALENT_TREE.Talents
...
// Everlasting Affliction - Row 9, Column 1
 const EVERLASTING_AFFLICTION = AFFLICTION_TALENT_TREE.Talents
...
// Haunt - Row 10, Column 1
 const HAUNT = AFFLICTION_TALENT_TREE.Talents
