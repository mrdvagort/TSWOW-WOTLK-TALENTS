...
export const DEMONOLOGY_TALENT_TREE = WARLOCK_CLASS.TalentTrees.get()[1]
...
export const IMPROVED_HEALTHSTONE = DEMONOLOGY_TALENT_TREE.Talents
...
export const IMPROVED_IMP = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_EMBRACE = DEMONOLOGY_TALENT_TREE.Talents
...
export const FEL_SYNERGY = DEMONOLOGY_TALENT_TREE.Talents
...
export const IMPROVED_HEALTH_FUNNEL = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_BRUTALITY = DEMONOLOGY_TALENT_TREE.Talents
...
export const FEL_VITALITY = DEMONOLOGY_TALENT_TREE.Talents
...
export const IMPROVED_SUCCUBUS = DEMONOLOGY_TALENT_TREE.Talents
...
export const SOUL_LINK = DEMONOLOGY_TALENT_TREE.Talents
...
export const FEL_DOMINATION = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_AEGIS = DEMONOLOGY_TALENT_TREE.Talents
...
export const UNHOLY_POWER = DEMONOLOGY_TALENT_TREE.Talents
...
export const MASTER_SUMMONER = DEMONOLOGY_TALENT_TREE.Talents
...
export const MANA_FEED = DEMONOLOGY_TALENT_TREE.Talents
...
export const MASTER_CONJUROR = DEMONOLOGY_TALENT_TREE.Talents
...
export const MASTER_DEMONOLOGIST = DEMONOLOGY_TALENT_TREE.Talents
...
export const MOLTEN_CORE = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_RESILIENCE = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_EMPOWERMENT = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_KNOWLEDGE = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_TACTICS = DEMONOLOGY_TALENT_TREE.Talents
...
export const DECIMATION = DEMONOLOGY_TALENT_TREE.Talents
...
export const IMPROVED_DEMONIC_TACTICS = DEMONOLOGY_TALENT_TREE.Talents
...
export const SUMMON_FELGUARD = DEMONOLOGY_TALENT_TREE.Talents
...
export const NEMESIS = DEMONOLOGY_TALENT_TREE.Talents
...
export const DEMONIC_PACT = DEMONOLOGY_TALENT_TREE.Talents
...
export const METAMORPHOSIS = DEMONOLOGY_TALENT_TREE.Talents
