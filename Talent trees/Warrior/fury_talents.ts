...
export const FURY_TALENT_TREE = WARRIOR_CLASS.TalentTrees.get()[1]
...
export const ARMORED_TO_THE_TEETH = FURY_TALENT_TREE.Talents
...
export const BOOMING_VOICE = FURY_TALENT_TREE.Talents
...
export const CRUELTY = FURY_TALENT_TREE.Talents
...
export const IMPROVED_DEMORALIZING_SHOUT = FURY_TALENT_TREE.Talents
...
export const UNBRIDLED_WRATH = FURY_TALENT_TREE.Talents
...
export const IMPROVED_CLEAVE = FURY_TALENT_TREE.Talents
...
export const PIERCING_HOWL = FURY_TALENT_TREE.Talents
...
export const BLOOD_CRAZE = FURY_TALENT_TREE.Talents
...
export const COMMANDING_PRESENCE = FURY_TALENT_TREE.Talents
...
export const DUAL_WIELD_SPECIALIZATION = FURY_TALENT_TREE.Talents
...
export const IMPROVED_EXECUTE = FURY_TALENT_TREE.Talents
...
export const ENRAGE = FURY_TALENT_TREE.Talents
...
export const PRECISION = FURY_TALENT_TREE.Talents
...
export const DEATH_WISH = FURY_TALENT_TREE.Talents
...
export const IMPROVED_INTERCEPT = FURY_TALENT_TREE.Talents
...
export const IMPROVED_BERSERKER_RAGE = FURY_TALENT_TREE.Talents
...
// Improved Berserker Rage - Row 3, Column 3
export const FLURRY = FURY_TALENT_TREE.Talents
...
export const INTENSIFY_RAGE = FURY_TALENT_TREE.Talents
...
export const BLOODTHIRST = FURY_TALENT_TREE.Talents
...
export const IMPROVED_WHIRLWIND = FURY_TALENT_TREE.Talents
...
export const FURIOUS_ATTACKS = FURY_TALENT_TREE.Talents
...
export const IMPROVED_BERSERKER_STANCE = FURY_TALENT_TREE.Talents
...
export const HEROIC_FURY = FURY_TALENT_TREE.Talents
...
export const RAMPAGE = FURY_TALENT_TREE.Talents
...
export const BLOODSURGE = FURY_TALENT_TREE.Talents
...
export const UNENDING_FURY = FURY_TALENT_TREE.Talents
...
export const TITANS_GRIP = FURY_TALENT_TREE.Talents
