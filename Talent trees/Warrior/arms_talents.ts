...
export const ARMS_TALENT_TREE = WARRIOR_CLASS.TalentTrees.get()[0]
...
export const IMPROVED_HEROIC_STRIKE = ARMS_TALENT_TREE.Talents
...
export const DEFLECTION = ARMS_TALENT_TREE.Talents
...
export const IMPROVED_REND = ARMS_TALENT_TREE.Talents
...
export const IMPROVED_CHARGE = ARMS_TALENT_TREE.Talents
...
export const IRON_WILL = ARMS_TALENT_TREE.Talents
...
export const TACTICAL_MASTERY = ARMS_TALENT_TREE.Talents
...
export const IMPROVED_OVERPOWER = ARMS_TALENT_TREE.Talents
...
export const ANGER_MANAGEMENT = ARMS_TALENT_TREE.Talents
...
export const IMPALE = ARMS_TALENT_TREE.Talents
...
export const DEEP_WOUNDS = ARMS_TALENT_TREE.Talents
...
export const TWO_HANDED_WEAPON_SPEC = ARMS_TALENT_TREE.Talents
...
export const TASTE_FOR_BLOOD = ARMS_TALENT_TREE.Talents
...
export const POLEAXE_SPEC = ARMS_TALENT_TREE.Talents
...
export const SWEEPING_STRIKES = ARMS_TALENT_TREE.Talents
...
export const MACE_SPEC = ARMS_TALENT_TREE.Talents
...
export const SWORD_SPEC = ARMS_TALENT_TREE.Talents
...
export const WEAPON_MASTERY = ARMS_TALENT_TREE.Talents
...
export const IMPROVED_HAMSTRING = ARMS_TALENT_TREE.Talents
...
export const TRAUMA = ARMS_TALENT_TREE.Talents
...
export const SECOND_WIND = ARMS_TALENT_TREE.Talents
...
export const MORTAL_STRIKE = ARMS_TALENT_TREE.Talents
...
export const STRENGTH_OF_ARMS = ARMS_TALENT_TREE.Talents
...
export const IMPROVED_SLAM = ARMS_TALENT_TREE.Talents
...
export const JUGGERNAUT = ARMS_TALENT_TREE.Talents
...
export const IMPROVED_MORTAL_STRIKE = ARMS_TALENT_TREE.Talents
...
export const UNRELENTING_ASSAULT = ARMS_TALENT_TREE.Talents
...
export const SUDDEN_DEATH = ARMS_TALENT_TREE.Talents
...
export const ENDLESS_RAGE = ARMS_TALENT_TREE.Talents
...
export const BLOOD_FRENZY = ARMS_TALENT_TREE.Talents
...
export const WRECKING_CREW = ARMS_TALENT_TREE.Talents
...
export const BLADESTORM = ARMS_TALENT_TREE.Talents
