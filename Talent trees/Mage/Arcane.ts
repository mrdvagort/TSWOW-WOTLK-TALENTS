...
export const ARCANE_TALENT_TREE = MAGE_CLASS.TalentTrees.get()[0]
...
export const ARCANE_SUBTLETY = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_FOCUS = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_STABILITY = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_FORTITUDE = ARCANE_TALENT_TREE.Talents
...
export const MAGIC_ABSORPTION = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_CONCENTRATION = ARCANE_TALENT_TREE.Talents
...
export const MAGIC_ATTUNEMENT = ARCANE_TALENT_TREE.Talents
...
export const SPELL_IMPACT = ARCANE_TALENT_TREE.Talents
...
export const STUDENT_OF_THE_MIND = ARCANE_TALENT_TREE.Talents
...
export const FOCUS_MAGIC = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_SHIELDING = ARCANE_TALENT_TREE.Talents
...
export const IMPROVED_COUNTERSPELL = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_MEDITATION = ARCANE_TALENT_TREE.Talents
...
export const TORMENT_THE_WEAK = ARCANE_TALENT_TREE.Talents
...
export const IMPROVED_BLINK = ARCANE_TALENT_TREE.Talents
...
export const PRESENCE_OF_MIND = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_MIND = ARCANE_TALENT_TREE.Talents
...
export const PRISMATIC_CLOAK = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_INSTABILITY = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_POTENCY = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_EMPOWERMENT = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_POWER = ARCANE_TALENT_TREE.Talents
...
export const INCANTER_S_ABSORPTION = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_FLOWS = ARCANE_TALENT_TREE.Talents
...
export const MIND_MASTERY = ARCANE_TALENT_TREE.Talents
...
// Slow - Row 8, Column 1
export const SLOW = ARCANE_TALENT_TREE.Talents
    .addGet("default", "slow")
    .Position.set(8, 1)
...
export const MISSILE_BARRAGE = ARCANE_TALENT_TREE.Talents
...
export const NETHERWIND_PRESENCE = ARCANE_TALENT_TREE.Talents
...
export const SPELL_POWER = ARCANE_TALENT_TREE.Talents
...
export const ARCANE_BARRAGE = ARCANE_TALENT_TREE.Talents
