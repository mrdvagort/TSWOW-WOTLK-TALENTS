...
// Get the Fire talent tree (index 1)
 const FIRE_TALENT_TREE = MAGE_CLASS.TalentTrees.get()[1]
...
// Improved Fire Blast - Row 0, Column 0
 const IMPROVED_FIRE_BLAST = FIRE_TALENT_TREE.Talents
...
// Incineration - Row 0, Column 1
 const INCINERATION = FIRE_TALENT_TREE.Talents
...
// Improved Fireball - Row 0, Column 2
 const IMPROVED_FIREBALL = FIRE_TALENT_TREE.Talents
...
// Ignite - Row 1, Column 0
 const IGNITE = FIRE_TALENT_TREE.Talents
...
// Burning Determination - Row 1, Column 1
 const BURNING_DETERMINATION = FIRE_TALENT_TREE.Talents
...
// World in Flames - Row 1, Column 2
 const WORLD_IN_FLAMES = FIRE_TALENT_TREE.Talents
...
// Flame Throwing - Row 2, Column 0
 const FLAME_THROWING = FIRE_TALENT_TREE.Talents
...
// Impact - Row 2, Column 1
 const IMPACT = FIRE_TALENT_TREE.Talents
...
// Pyroblast - Row 2, Column 2
 const PYROBLAST = FIRE_TALENT_TREE.Talents
...
// Burning Soul - Row 2, Column 3
 const BURNING_SOUL = FIRE_TALENT_TREE.Talents
...
// Improved Scorch - Row 3, Column 0
 const IMPROVED_SCORCH = FIRE_TALENT_TREE.Talents
...
// Molten Shields - Row 3, Column 1
 const MOLTEN_SHIELDS = FIRE_TALENT_TREE.Talents
...
// Master of Elements - Row 3, Column 3
 const MASTER_OF_ELEMENTS = FIRE_TALENT_TREE.Talents
...
// Playing with Fire - Row 4, Column 0
 const PLAYING_WITH_FIRE = FIRE_TALENT_TREE.Talents
...
// Critical Mass - Row 4, Column 1
 const CRITICAL_MASS = FIRE_TALENT_TREE.Talents
...
// Blast Wave - Row 4, Column 2
 const BLAST_WAVE = FIRE_TALENT_TREE.Talents
...
// Blazing Speed - Row 5, Column 0
 const BLAZING_SPEED = FIRE_TALENT_TREE.Talents
...
// Fire Power - Row 5, Column 2
 const FIRE_POWER = FIRE_TALENT_TREE.Talents
...
// Pyromaniac - Row 6, Column 0
 const PYROMANIAC = FIRE_TALENT_TREE.Talents
...
// Combustion - Row 6, Column 1
 const COMBUSTION = FIRE_TALENT_TREE.Talents
...
// Molten Fury - Row 6, Column 2
 const MOLTEN_FURY = FIRE_TALENT_TREE.Talents
...
// Fiery Payback - Row 7, Column 0
 const FIERY_PAYBACK = FIRE_TALENT_TREE.Talents
...
// Empowered Fire - Row 7, Column 2
 const EMPOWERED_FIRE = FIRE_TALENT_TREE.Talents
...
// Firestarter - Row 8, Column 0
 const FIRESTARTER = FIRE_TALENT_TREE.Talents
...
// Dragon's Breath - Row 8, Column 1
 const DRAGON_S_BREATH = FIRE_TALENT_TREE.Talents
...
// Hot Streak - Row 8, Column 2
 const HOT_STREAK = FIRE_TALENT_TREE.Talents
...
// Burnout - Row 9, Column 1
 const BURNOUT = FIRE_TALENT_TREE.Talents
...
// Living Bomb - Row 10, Column 1
 const LIVING_BOMB = FIRE_TALENT_TREE.Talents
