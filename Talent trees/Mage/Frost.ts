...
export const FROST_TALENT_TREE = MAGE_CLASS.TalentTrees.get()[2]
...
export const FROSTBITE = FROST_TALENT_TREE.Talents
...
export const IMPROVED_FROSTBOLT = FROST_TALENT_TREE.Talents
...
export const ICE_FLOES = FROST_TALENT_TREE.Talents
...
export const ICE_SHARDS = FROST_TALENT_TREE.Talents
...
export const FROST_WARDING = FROST_TALENT_TREE.Talents
...
export const MAGE_PRECISION = FROST_TALENT_TREE.Talents
...
export const PERMAFROST = FROST_TALENT_TREE.Talents
...
export const PIERCING_ICE = FROST_TALENT_TREE.Talents
...
export const ICY_VEINS = FROST_TALENT_TREE.Talents
...
export const IMPROVED_BLIZZARD = FROST_TALENT_TREE.Talents
...
export const ARCTIC_REACH = FROST_TALENT_TREE.Talents
...
export const FROST_CHANNELING = FROST_TALENT_TREE.Talents
...
export const SHATTER = FROST_TALENT_TREE.Talents
...
export const COLD_SNAP = FROST_TALENT_TREE.Talents
...
export const IMPROVED_CONE_OF_COLD = FROST_TALENT_TREE.Talents
...
export const FROZEN_CORE = FROST_TALENT_TREE.Talents
...
export const COLD_AS_ICE = FROST_TALENT_TREE.Talents
...
export const WINTER_S_CHILL = FROST_TALENT_TREE.Talents
...
export const SHATTERED_BARRIER = FROST_TALENT_TREE.Talents
...
export const ICE_BARRIER = FROST_TALENT_TREE.Talents
...
export const ARCTIC_WINDS = FROST_TALENT_TREE.Talents
...
export const EMPOWERED_FROSTBOLT = FROST_TALENT_TREE.Talents
...
export const FINGERS_OF_FROST = FROST_TALENT_TREE.Talents
...
export const BRAIN_FREEZE = FROST_TALENT_TREE.Talents
...
export const SUMMON_WATER_ELEMENTAL = FROST_TALENT_TREE.Talents
...
export const ENDURING_WINTER = FROST_TALENT_TREE.Talents
...
export const CHILLED_TO_THE_BONE = FROST_TALENT_TREE.Talents
...
export const DEEP_FREEZE = FROST_TALENT_TREE.Talents
