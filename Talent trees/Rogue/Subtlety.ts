...
export const SUBTLETY_TALENT_TREE = ROGUE_CLASS.TalentTrees.get()[2]
...
export const RELENTLESS_STRIKES = SUBTLETY_TALENT_TREE.Talents
...
export const MASTER_OF_DECEPTION = SUBTLETY_TALENT_TREE.Talents
...
export const OPPORTUNITY = SUBTLETY_TALENT_TREE.Talents
...
export const SLEIGHT_OF_HAND = SUBTLETY_TALENT_TREE.Talents
...
export const DIRTY_TRICKS = SUBTLETY_TALENT_TREE.Talents
...
export const CAMOUFLAGE = SUBTLETY_TALENT_TREE.Talents
...
export const ELUSIVENESS = SUBTLETY_TALENT_TREE.Talents
...
export const GHOSTLY_STRIKE = SUBTLETY_TALENT_TREE.Talents
...
export const SERRATED_BLADES = SUBTLETY_TALENT_TREE.Talents
...
export const SETUP = SUBTLETY_TALENT_TREE.Talents
...
export const INITIATIVE = SUBTLETY_TALENT_TREE.Talents
...
export const IMPROVED_AMBUSH = SUBTLETY_TALENT_TREE.Talents
...
export const HEIGHTENED_SENSES = SUBTLETY_TALENT_TREE.Talents
...
export const PREPARATION = SUBTLETY_TALENT_TREE.Talents
...
export const DIRTY_DEEDS = SUBTLETY_TALENT_TREE.Talents
...
export const HEMORRHAGE = SUBTLETY_TALENT_TREE.Talents
...
export const MASTER_OF_SUBTLETY = SUBTLETY_TALENT_TREE.Talents
...
export const DEADLINESS = SUBTLETY_TALENT_TREE.Talents
...
export const ENVELOPING_SHADOWS = SUBTLETY_TALENT_TREE.Talents
...
export const PREMEDITATION = SUBTLETY_TALENT_TREE.Talents
...
export const CHEAT_DEATH = SUBTLETY_TALENT_TREE.Talents
...
export const SINISTER_CALLING = SUBTLETY_TALENT_TREE.Talents
...
export const WAYLAY = SUBTLETY_TALENT_TREE.Talents
...
export const HONOR_AMONG_THIEVES = SUBTLETY_TALENT_TREE.Talents
...
export const SHADOWSTEP = SUBTLETY_TALENT_TREE.Talents
...
export const FILTHY_TRICKS = SUBTLETY_TALENT_TREE.Talents
...
export const SLAUGHTER_FROM_THE_SHADOWS = SUBTLETY_TALENT_TREE.Talents
...
export const SHADOW_DANCE = SUBTLETY_TALENT_TREE.Talents
