...
export const COMBAT_TALENT_TREE = ROGUE_CLASS.TalentTrees.get()[0]
...
export const IMPROVED_EVISCERATE = COMBAT_TALENT_TREE.Talents
...
export const REMORSELESS_ATTACKS = COMBAT_TALENT_TREE.Talents
...
export const MALICE = COMBAT_TALENT_TREE.Talents
...
export const RUTHLESSNESS = COMBAT_TALENT_TREE.Talents
...
export const BLOOD_SPATTER = COMBAT_TALENT_TREE.Talents
...
export const PUNCTURING_WOUNDS = COMBAT_TALENT_TREE.Talents
...
export const VIGOR = COMBAT_TALENT_TREE.Talents
...
export const IMPROVED_EXPOSE_ARMOR = COMBAT_TALENT_TREE.Talents
...
export const LETHALITY = COMBAT_TALENT_TREE.Talents
...
export const VILE_POISONS = COMBAT_TALENT_TREE.Talents
...
export const IMPROVED_POISONS = COMBAT_TALENT_TREE.Talents
...
export const FLEET_FOOTED = COMBAT_TALENT_TREE.Talents
...
export const COLD_BLOOD = COMBAT_TALENT_TREE.Talents
...
export const IMPROVED_KIDNEY_SHOT = COMBAT_TALENT_TREE.Talents
...
export const QUICK_RECOVERY = COMBAT_TALENT_TREE.Talents
...
export const SEAL_FATE = COMBAT_TALENT_TREE.Talents
...
export const MURDER = COMBAT_TALENT_TREE.Talents
...
export const DEADLY_BREW = COMBAT_TALENT_TREE.Talents
...
export const OVERKILL = COMBAT_TALENT_TREE.Talents
...
export const DEADENED_NERVES = COMBAT_TALENT_TREE.Talents
...
export const FOCUSED_ATTACKS = COMBAT_TALENT_TREE.Talents
...
export const FIND_WEAKNESS = COMBAT_TALENT_TREE.Talents
...
export const MASTER_POISONER = COMBAT_TALENT_TREE.Talents
...
export const MUTILATE = COMBAT_TALENT_TREE.Talents
...
export const TURN_THE_TABLES = COMBAT_TALENT_TREE.Talents
...
export const CUT_TO_THE_CHASE = COMBAT_TALENT_TREE.Talents
...
export const HUNGER_FOR_BLOOD = COMBAT_TALENT_TREE.Talents
