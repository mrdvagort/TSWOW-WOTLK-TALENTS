...
export const ASSASSINATION_TALENT_TREE = ROGUE_CLASS.TalentTrees.get()[0]
...
export const IMPROVED_GOUGE = ASSASSINATION_TALENT_TREE.Talents
...
export const IMPROVED_SINISTER_STRIKE = ASSASSINATION_TALENT_TREE.Talents
...
export const ROGUE_DUAL_WIELD_SPECIALIZATION = ASSASSINATION_TALENT_TREE.Talents
...
export const IMPROVED_SLICE_AND_DICE = ASSASSINATION_TALENT_TREE.Talents
...
export const ROGUE_DEFLECTION = ASSASSINATION_TALENT_TREE.Talents
...
export const ROGUE_PRECISION = ASSASSINATION_TALENT_TREE.Talents
...
export const ENDURANCE = ASSASSINATION_TALENT_TREE.Talents
...
export const RIPOSTE = ASSASSINATION_TALENT_TREE.Talents
...
export const CLOSE_QUARTERS_COMBAT = ASSASSINATION_TALENT_TREE.Talents
...
export const IMPROVED_KICK = ASSASSINATION_TALENT_TREE.Talents
...
export const IMPROVED_SPRINT = ASSASSINATION_TALENT_TREE.Talents
...
export const ROGUE_LIGHTNING_REFLEXES = ASSASSINATION_TALENT_TREE.Talents
...
export const AGGRESSION = ASSASSINATION_TALENT_TREE.Talents
...
export const ROGUE_MACE_SPECIALIZATION = ASSASSINATION_TALENT_TREE.Talents
...
export const BLADE_FLURRY = ASSASSINATION_TALENT_TREE.Talents
...
export const HACK_AND_SLASH = ASSASSINATION_TALENT_TREE.Talents
...
export const WEAPON_EXPERTISE = ASSASSINATION_TALENT_TREE.Talents
...
export const BLADE_TWISTING = ASSASSINATION_TALENT_TREE.Talents
...
export const ROGUE_VITALITY = ASSASSINATION_TALENT_TREE.Talents
...
export const ADRENALINE_RUSH = ASSASSINATION_TALENT_TREE.Talents
...
export const NERVES_OF_STEEL = ASSASSINATION_TALENT_TREE.Talents
...
export const THROWING_SPECIALIZATION = ASSASSINATION_TALENT_TREE.Talents
...
export const COMBAT_POTENCY = ASSASSINATION_TALENT_TREE.Talents
...
export const UNFAIR_ADVANTAGE = ASSASSINATION_TALENT_TREE.Talents
...
export const SURPRISE_ATTACKS = ASSASSINATION_TALENT_TREE.Talents
...
export const SAVAGE_COMBAT = ASSASSINATION_TALENT_TREE.Talents
...
export const PREY_ON_THE_WEAK = ASSASSINATION_TALENT_TREE.Talents
...
export const KILLING_SPREE = ASSASSINATION_TALENT_TREE.Talents
