...
export const SURVIVAL_TALENT_TREE = HUNTER_CLASS.TalentTrees.get()[2]
...
export const IMPROVED_TRACKING = SURVIVAL_TALENT_TREE.Talents
...
export const HAWK_EYE = SURVIVAL_TALENT_TREE.Talents
...
export const SAVAGE_STRIKES = SURVIVAL_TALENT_TREE.Talents
...
export const SUREFOOTED = SURVIVAL_TALENT_TREE.Talents
...
export const ENTRAPMENT = SURVIVAL_TALENT_TREE.Talents
...
export const TRAP_MASTERY = SURVIVAL_TALENT_TREE.Talents
...
export const Survival_SURVIVAL_INSTINCTS = SURVIVAL_TALENT_TREE.Talents
...
export const SURVIVALIST = SURVIVAL_TALENT_TREE.Talents
...
export const SCATTER_SHOT = SURVIVAL_TALENT_TREE.Talents
...
export const HUNTER_DEFLECTION = SURVIVAL_TALENT_TREE.Talents
...
export const SURVIVAL_TACTICS = SURVIVAL_TALENT_TREE.Talents
...
export const T_N_T = SURVIVAL_TALENT_TREE.Talents
...
export const LOCK_AND_LOAD = SURVIVAL_TALENT_TREE.Talents
...
export const HUNTER_VS_WILD = SURVIVAL_TALENT_TREE.Talents
...
export const KILLER_INSTINCT = SURVIVAL_TALENT_TREE.Talents
...
export const COUNTERATTACK = SURVIVAL_TALENT_TREE.Talents
...
export const LIGHTNING_REFLEXES = SURVIVAL_TALENT_TREE.Talents
...
export const RESOURCEFULNESS = SURVIVAL_TALENT_TREE.Talents
...
export const EXPOSE_WEAKNESS = SURVIVAL_TALENT_TREE.Talents
...
export const WYVERN_STING = SURVIVAL_TALENT_TREE.Talents
...
export const THRILL_OF_THE_HUNT = SURVIVAL_TALENT_TREE.Talents
...
export const MASTER_TACTICIAN = SURVIVAL_TALENT_TREE.Talents
...
export const NOXIOUS_STINGS = SURVIVAL_TALENT_TREE.Talents
...
export const POINT_OF_NO_ESCAPE = SURVIVAL_TALENT_TREE.Talents
...
export const BLACK_ARROW = SURVIVAL_TALENT_TREE.Talents
...
export const SNIPER_TRAINING = SURVIVAL_TALENT_TREE.Talents
...
export const HUNTING_PARTY = SURVIVAL_TALENT_TREE.Talents
...
export const EXPLOSIVE_SHOT = SURVIVAL_TALENT_TREE.Talents
