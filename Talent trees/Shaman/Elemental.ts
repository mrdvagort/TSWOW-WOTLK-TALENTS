...
// Get the original Arms talent tree (index 0)
 const Elemental_TALENT_TREE = SHAMAN_CLASS_CLASS.TalentTrees.get()[0]
...
// Convection - Row 0, Column 1
 const CONVECTION = Elemental_TALENT_TREE.Talents
...
// Concussion - Row 0, Column 2
 const CONCUSSION = Elemental_TALENT_TREE.Talents
...
// Call of Flame - Row 1, Column 0
 const CALL_OF_FLAME = Elemental_TALENT_TREE.Talents
...
// Elemental Warding - Row 1, Column 1
 const ELEMENTAL_WARDING = Elemental_TALENT_TREE.Talents
...
// Elemental Devastation - Row 1, Column 2
 const ELEMENTAL_DEVASTATION = Elemental_TALENT_TREE.Talents
...
// Reverberation - Row 2, Column 0
 const REVERBERATION = Elemental_TALENT_TREE.Talents
...
// Elemental Focus - Row 2, Column 1
 const ELEMENTAL_FOCUS = Elemental_TALENT_TREE.Talents
...
// Elemental Fury - Row 2, Column 2
 const ELEMENTAL_FURY = Elemental_TALENT_TREE.Talents
...
// Improved Fire Nova - Row 3, Column 0
 const IMPROVED_FIRE_NOVA = Elemental_TALENT_TREE.Talents
...
// Eye of the Storm - Row 3, Column 3
 const EYE_OF_THE_STORM = Elemental_TALENT_TREE.Talents
...
// Elemental Reach - Row 4, Column 0
 const ELEMENTAL_REACH = Elemental_TALENT_TREE.Talents
...
// Call of Thunder - Row 4, Column 1
 const CALL_OF_THUNDER = Elemental_TALENT_TREE.Talents
...
// Unrelenting Storm - Row 4, Column 3
 const UNRELENTING_STORM = Elemental_TALENT_TREE.Talents
...
// Elemental Precision - Row 5, Column 0
 const ELEMENTAL_PRECISION = Elemental_TALENT_TREE.Talents
...
// Lightning Mastery - Row 5, Column 2
 const LIGHTNING_MASTERY = Elemental_TALENT_TREE.Talents
...
// Elemental Mastery - Row 6, Column 1
 const ELEMENTAL_MASTERY = Elemental_TALENT_TREE.Talents
...
// Storm, Earth and Fire - Row 6, Column 2
 const STORM_EARTH_AND_FIRE = Elemental_TALENT_TREE.Talents
...
// Booming Echoes - Row 7, Column 0
 const BOOMING_ECHOES = Elemental_TALENT_TREE.Talents
...
// Elemental Oath - Row 7, Column 1
 const ELEMENTAL_OATH = Elemental_TALENT_TREE.Talents
...
// Lightning Overload - Row 7, Column 2
 const LIGHTNING_OVERLOAD = Elemental_TALENT_TREE.Talents
...
// Astral Shift - Row 8, Column 0
 const ASTRAL_SHIFT = Elemental_TALENT_TREE.Talents
...
// Totem of Wrath - Row 8, Column 1
 const TOTEM_OF_WRATH = Elemental_TALENT_TREE.Talents
...
// Lava Flows - Row 8, Column 2
 const LAVA_FLOWS = Elemental_TALENT_TREE.Talents
...
// Shamanism - Row 9, Column 1
 const SHAMANISM = Elemental_TALENT_TREE.Talents
...
// Thunderstorm - Row 10, Column 1
 const THUNDERSTORM = Elemental_TALENT_TREE.Talents
