...
// Get the original Arms talent tree (index 0)
 const Restoration_TALENT_TREE = SHAMAN_CLASS_CLASS.TalentTrees.get()[2]
...
// Improved Healing Wave - Row 0, Column 1
 const IMPROVED_HEALING_WAVE = Restoration_TALENT_TREE.Talents
...
// Totemic Focus - Row 0, Column 2
 const TOTEMIC_FOCUS = Restoration_TALENT_TREE.Talents
...
// Improved Reincarnation - Row 1, Column 0
 const IMPROVED_REINCARNATION = Restoration_TALENT_TREE.Talents
...
// Healing Grace - Row 1, Column 1
 const HEALING_GRACE = Restoration_TALENT_TREE.Talents
...
// Tidal Focus - Row 1, Column 2
 const TIDAL_FOCUS = Restoration_TALENT_TREE.Talents
...
// Improved Water Shield - Row 2, Column 0
 const IMPROVED_WATER_SHIELD = Restoration_TALENT_TREE.Talents
...
// Healing Focus - Row 2, Column 1
 const SHAMAN_HEALING_FOCUS = Restoration_TALENT_TREE.Talents
...
// Tidal Force - Row 2, Column 2
 const TIDAL_FORCE = Restoration_TALENT_TREE.Talents
...
// Ancestral Healing - Row 2, Column 3
 const ANCESTRAL_HEALING = Restoration_TALENT_TREE.Talents
...
// Restorative Totems - Row 3, Column 1
 const RESTORATIVE_TOTEMS = Restoration_TALENT_TREE.Talents
...
// Tidal Mastery - Row 3, Column 2
 const TIDAL_MASTERY = Restoration_TALENT_TREE.Talents
...
// Healing Way - Row 4, Column 0
 const HEALING_WAY = Restoration_TALENT_TREE.Talents
...
// Nature's Swiftness - Row 4, Column 2
 const SHAMAN_NATURES_SWIFTNESS = Restoration_TALENT_TREE.Talents
...
// Focused Mind - Row 4, Column 3
 const FOCUSED_MIND = Restoration_TALENT_TREE.Talents
...
// Purification - Row 5, Column 2
 const PURIFICATION = Restoration_TALENT_TREE.Talents
...
// Nature's Guardian - Row 6, Column 0
 const NATURE_S_GUARDIAN = Restoration_TALENT_TREE.Talents
...
// Mana Tide Totem - Row 6, Column 1
 const MANA_TIDE_TOTEM = Restoration_TALENT_TREE.Talents
...
// Cleanse Spirit - Row 6, Column 2
 const CLEANSE_SPIRIT = Restoration_TALENT_TREE.Talents
...
// Blessing of the Eternals - Row 7, Column 0
 const BLESSING_OF_THE_ETERNALS = Restoration_TALENT_TREE.Talents
...
// Improved Chain Heal - Row 7, Column 1
 const IMPROVED_CHAIN_HEAL = Restoration_TALENT_TREE.Talents
...
// Nature's Blessing - Row 7, Column 2
 const NATURE_S_BLESSING = Restoration_TALENT_TREE.Talents
...
// Ancestral Awakening - Row 8, Column 0
 const ANCESTRAL_AWAKENING = Restoration_TALENT_TREE.Talents
...
// Earth Shield - Row 8, Column 1
 const EARTH_SHIELD = Restoration_TALENT_TREE.Talents
...
// Improved Earth Shield - Row 8, Column 2
 const IMPROVED_EARTH_SHIELD = Restoration_TALENT_TREE.Talents
...
// Tidal Waves - Row 9, Column 1
 const TIDAL_WAVES = Restoration_TALENT_TREE.Talents
...
// Riptide - Row 10, Column 1
 const RIPTIDE = Restoration_TALENT_TREE.Talents
