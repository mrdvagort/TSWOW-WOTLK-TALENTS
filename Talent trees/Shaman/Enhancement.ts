...
export const ENHANCEMENT_TALENT_TREE = SHAMAN_CLASS.TalentTrees.get()[1]
...
export const ENHANCING_TOTEMS = ENHANCEMENT_TALENT_TREE.Talents
...
export const EARTH_S_GRASP = ENHANCEMENT_TALENT_TREE.Talents
...
export const ANCESTRAL_KNOWLEDGE = ENHANCEMENT_TALENT_TREE.Talents
...
export const GUARDIAN_TOTEMS = ENHANCEMENT_TALENT_TREE.Talents
...
export const THUNDERING_STRIKES = ENHANCEMENT_TALENT_TREE.Talents
...
export const IMPROVED_GHOST_WOLF = ENHANCEMENT_TALENT_TREE.Talents
...
export const IMPROVED_SHIELDS = ENHANCEMENT_TALENT_TREE.Talents
...
export const ELEMENTAL_WEAPONS = ENHANCEMENT_TALENT_TREE.Talents
...
export const SHAMANISTIC_FOCUS = ENHANCEMENT_TALENT_TREE.Talents
...
export const ANTICIPATION = ENHANCEMENT_TALENT_TREE.Talents
...
export const FLURRY = ENHANCEMENT_TALENT_TREE.Talents
...
export const TOUGHNESS = ENHANCEMENT_TALENT_TREE.Talents
...
export const IMPROVED_WINDFURY_TOTEM = ENHANCEMENT_TALENT_TREE.Talents
...
export const SPIRIT_WEAPONS = ENHANCEMENT_TALENT_TREE.Talents
...
export const MENTAL_DEXTERITY = ENHANCEMENT_TALENT_TREE.Talents
...
export const UNLEASHED_RAGE = ENHANCEMENT_TALENT_TREE.Talents
...
export const Enhancement_WEAPON_MASTERY = ENHANCEMENT_TALENT_TREE.Talents
...
export const FROZEN_POWER = ENHANCEMENT_TALENT_TREE.Talents
...
export const DUAL_WIELD = ENHANCEMENT_TALENT_TREE.Talents
...
export const Enhancement_DUAL_WIELD_SPECIALIZATION = ENHANCEMENT_TALENT_TREE.Talents
...
export const STORMSTRIKE = ENHANCEMENT_TALENT_TREE.Talents
...
export const STATIC_SHOCK = ENHANCEMENT_TALENT_TREE.Talents
...
export const LAVA_LASH = ENHANCEMENT_TALENT_TREE.Talents
...
export const IMPROVED_STORMSTRIKE = ENHANCEMENT_TALENT_TREE.Talents
...
export const MENTAL_QUICKNESS = ENHANCEMENT_TALENT_TREE.Talents
...
export const SHAMANISTIC_RAGE = ENHANCEMENT_TALENT_TREE.Talents
...
export const EARTHEN_POWER = ENHANCEMENT_TALENT_TREE.Talents
...
export const MAELSTROM_WEAPON = ENHANCEMENT_TALENT_TREE.Talents
...
export const FERAL_SPIRIT = ENHANCEMENT_TALENT_TREE.Talents
