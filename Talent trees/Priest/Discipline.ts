...
// Get the Discipline talent tree (index 0)
 const DISCIPLINE_TALENT_TREE = PRIEST_CLASS.TalentTrees.get()[0]
...
// Unbreakable Will - Row 0, Column 1
 const UNBREAKABLE_WILL = DISCIPLINE_TALENT_TREE.Talents
...
// Twin Disciplines - Row 0, Column 2
 const TWIN_DISCIPLINES = DISCIPLINE_TALENT_TREE.Talents
...
// Silent Resolve - Row 1, Column 0
 const SILENT_RESOLVE = DISCIPLINE_TALENT_TREE.Talents
...
// Improved Inner Fire - Row 1, Column 1
 const IMPROVED_INNER_FIRE = DISCIPLINE_TALENT_TREE.Talents
...
// Improved Power Word: Fortitude - Row 1, Column 2
 const IMPROVED_POWER_WORD_FORTITUDE = DISCIPLINE_TALENT_TREE.Talents
...
// Martyrdom - Row 1, Column 3
 const MARTYRDOM = DISCIPLINE_TALENT_TREE.Talents
...
// Meditation - Row 2, Column 0
 const MEDITATION = DISCIPLINE_TALENT_TREE.Talents
...
// Inner Focus - Row 2, Column 1
 const INNER_FOCUS = DISCIPLINE_TALENT_TREE.Talents
...
// Improved Power Word: Shield - Row 2, Column 2
 const IMPROVED_POWER_WORD_SHIELD = DISCIPLINE_TALENT_TREE.Talents
...
// Absolution - Row 3, Column 0
 const ABSOLUTION = DISCIPLINE_TALENT_TREE.Talents
...
// Mental Agility - Row 3, Column 1
 const MENTAL_AGILITY = DISCIPLINE_TALENT_TREE.Talents
...
// Improved Mana Burn - Row 3, Column 3
 const IMPROVED_MANA_BURN = DISCIPLINE_TALENT_TREE.Talents
...
// Reflective Shield - Row 4, Column 0
 const REFLECTIVE_SHIELD = DISCIPLINE_TALENT_TREE.Talents
...
// Mental Strength - Row 4, Column 1
 const MENTAL_STRENGTH = DISCIPLINE_TALENT_TREE.Talents
...
// Soul Warding - Row 4, Column 2
 const SOUL_WARDING = DISCIPLINE_TALENT_TREE.Talents
...
// Focused Power - Row 5, Column 0
 const FOCUSED_POWER = DISCIPLINE_TALENT_TREE.Talents
...
// Enlightenment - Row 5, Column 2
 const ENLIGHTENMENT = DISCIPLINE_TALENT_TREE.Talents
...
// Focused Will - Row 6, Column 0
 const FOCUSED_WILL = DISCIPLINE_TALENT_TREE.Talents
...
// Power Infusion - Row 6, Column 1
 const POWER_INFUSION = DISCIPLINE_TALENT_TREE.Talents
...
// Improved Flash Heal - Row 6, Column 2
 const IMPROVED_FLASH_HEAL = DISCIPLINE_TALENT_TREE.Talents
...
// Renewed Hope - Row 7, Column 0
 const RENEWED_HOPE = DISCIPLINE_TALENT_TREE.Talents
...
// Rapture - Row 7, Column 1
 const RAPTURE = DISCIPLINE_TALENT_TREE.Talents
...
// Aspiration - Row 7, Column 2
 const ASPIRATION = DISCIPLINE_TALENT_TREE.Talents
...
// Divine Aegis - Row 8, Column 0
 const DIVINE_AEGIS = DISCIPLINE_TALENT_TREE.Talents
...
// Pain Suppression - Row 8, Column 1
 const PAIN_SUPPRESSION = DISCIPLINE_TALENT_TREE.Talents
...
// Grace - Row 8, Column 2
 const GRACE = DISCIPLINE_TALENT_TREE.Talents
...
// Borrowed Time - Row 9, Column 1
 const BORROWED_TIME = DISCIPLINE_TALENT_TREE.Talents
...
// Penance - Row 10, Column 1
 const PENANCE = DISCIPLINE_TALENT_TREE.Talents
