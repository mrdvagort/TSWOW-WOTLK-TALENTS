...
// Get the Shadow talent tree (index 2)
 const SHADOW_TALENT_TREE = PRIEST_CLASS.TalentTrees.get()[2]
...
// Spirit Tap - Row 0, Column 0
 const SPIRIT_TAP = SHADOW_TALENT_TREE.Talents
...
// Improved Spirit Tap - Row 0, Column 1
 const IMPROVED_SPIRIT_TAP = SHADOW_TALENT_TREE.Talents
...
// Darkness - Row 0, Column 2
 const DARKNESS = SHADOW_TALENT_TREE.Talents
...
// Shadow Affinity - Row 1, Column 0
 const SHADOW_AFFINITY = SHADOW_TALENT_TREE.Talents
...
// Improved Shadow Word: Pain - Row 1, Column 1
 const IMPROVED_SHADOW_WORD_PAIN = SHADOW_TALENT_TREE.Talents
...
// Shadow Focus - Row 1, Column 2
 const SHADOW_FOCUS = SHADOW_TALENT_TREE.Talents
...
// Improved Psychic Scream - Row 2, Column 0
 const IMPROVED_PSYCHIC_SCREAM = SHADOW_TALENT_TREE.Talents
...
// Improved Mind Blast - Row 2, Column 1
 const IMPROVED_MIND_BLAST = SHADOW_TALENT_TREE.Talents
...
// Mind Flay - Row 2, Column 2
 const MIND_FLAY = SHADOW_TALENT_TREE.Talents
...
// Veiled Shadows - Row 3, Column 1
 const VEILED_SHADOWS = SHADOW_TALENT_TREE.Talents
...
// Shadow Reach - Row 3, Column 2
 const SHADOW_REACH = SHADOW_TALENT_TREE.Talents
...
// Shadow Weaving - Row 3, Column 3
 const SHADOW_WEAVING = SHADOW_TALENT_TREE.Talents
...
// Silence - Row 4, Column 0
 const SILENCE = SHADOW_TALENT_TREE.Talents
...
// Vampiric Embrace - Row 4, Column 1
 const VAMPIRIC_EMBRACE = SHADOW_TALENT_TREE.Talents
...
// Improved Vampiric Embrace - Row 4, Column 2
 const IMPROVED_VAMPIRIC_EMBRACE = SHADOW_TALENT_TREE.Talents
...
// Focused Mind - Row 4, Column 3
 const PRIEST_FOCUSED_MIND = SHADOW_TALENT_TREE.Talents
...
// Mind Melt - Row 5, Column 0
 const MIND_MELT = SHADOW_TALENT_TREE.Talents
...
// Improved Devouring Plague - Row 5, Column 2
 const IMPROVED_DEVOURING_PLAGUE = SHADOW_TALENT_TREE.Talents
...
// Shadowform - Row 6, Column 1
 const SHADOWFORM = SHADOW_TALENT_TREE.Talents
...
// Shadow Power - Row 6, Column 2
 const SHADOW_POWER = SHADOW_TALENT_TREE.Talents
...
// Improved Shadowform - Row 7, Column 0
 const IMPROVED_SHADOWFORM = SHADOW_TALENT_TREE.Talents
...
// Misery - Row 7, Column 2
 const MISERY = SHADOW_TALENT_TREE.Talents
...
// Psychic Horror - Row 8, Column 0
 const PSYCHIC_HORROR = SHADOW_TALENT_TREE.Talents
...
// Vampiric Touch - Row 8, Column 1
 const VAMPIRIC_TOUCH = SHADOW_TALENT_TREE.Talents
...
// Pain and Suffering - Row 8, Column 2
 const PAIN_AND_SUFFERING = SHADOW_TALENT_TREE.Talents
...
// Twisted Faith - Row 9, Column 2
 const TWISTED_FAITH = SHADOW_TALENT_TREE.Talents
...
// Dispersion - Row 10, Column 1
 const DISPERSION = SHADOW_TALENT_TREE.Talents
