...
// Get the original Retribution talent tree (index 2)
 const RETRIBUTION_TALENT_TREE = PALADIN_CLASS.TalentTrees.get()[2]
...
// Deflection - Row 0, Column 0
 const RETRIBUTION_DEFLECTION = RETRIBUTION_TALENT_TREE.Talents
...
// Benediction - Row 0, Column 2
 const BENEDICTION = RETRIBUTION_TALENT_TREE.Talents
...
// Improved Judgements - Row 1, Column 0
 const IMPROVED_JUDGEMENTS = RETRIBUTION_TALENT_TREE.Talents
...
// Heart of the Crusader - Row 1, Column 1
 const HEART_OF_THE_CRUSADER = RETRIBUTION_TALENT_TREE.Talents
...
// Improved Blessing of Might - Row 1, Column 2
 const IMPROVED_BLESSING_OF_MIGHT = RETRIBUTION_TALENT_TREE.Talents
...
// Vindication - Row 2, Column 0
 const VINDICATION = RETRIBUTION_TALENT_TREE.Talents
...
// Conviction - Row 2, Column 1
 const CONVICTION = RETRIBUTION_TALENT_TREE.Talents
...
// Seal of Command - Row 2, Column 2
 const SEAL_OF_COMMAND = RETRIBUTION_TALENT_TREE.Talents
...
// Pursuit of Justice - Row 2, Column 3
 const PURSUIT_OF_JUSTICE = RETRIBUTION_TALENT_TREE.Talents
...
// Eye for an Eye - Row 3, Column 0
 const EYE_FOR_AN_EYE = RETRIBUTION_TALENT_TREE.Talents
...
// Sanctity of Battle - Row 3, Column 1
 const SANCTITY_OF_BATTLE = RETRIBUTION_TALENT_TREE.Talents
...
// Crusade - Row 3, Column 2
 const CRUSADE = RETRIBUTION_TALENT_TREE.Talents
...
// Two-Handed Weapon Specialization - Row 4, Column 1
 const TWO_HANDED_WEAPON_SPECIALIZATION = RETRIBUTION_TALENT_TREE.Talents
...
// Sanctified Retribution - Row 4, Column 2
 const SANCTIFIED_RETRIBUTION = RETRIBUTION_TALENT_TREE.Talents
...
// Vengeance - Row 5, Column 0
 const PALADIN_VENGEANCE = RETRIBUTION_TALENT_TREE.Talents
...
// Divine Purpose - Row 5, Column 2
 const DIVINE_PURPOSE = RETRIBUTION_TALENT_TREE.Talents
...
// The Art of War - Row 6, Column 0
 const THE_ART_OF_WAR = RETRIBUTION_TALENT_TREE.Talents
...
// Repentance - Row 6, Column 1
 const REPENTANCE = RETRIBUTION_TALENT_TREE.Talents
...
// Judgements of the Wise - Row 6, Column 2
 const JUDGEMENTS_OF_THE_WISE = RETRIBUTION_TALENT_TREE.Talents
...
// Fanaticism - Row 7, Column 0
 const FANATICISM = RETRIBUTION_TALENT_TREE.Talents
...
// Sanctified Wrath - Row 7, Column 2
 const SANCTIFIED_WRATH = RETRIBUTION_TALENT_TREE.Talents
...
// Swift Retribution - Row 8, Column 0
 const SWIFT_RETRIBUTION = RETRIBUTION_TALENT_TREE.Talents
...
// Crusader Strike - Row 8, Column 1
 const CRUSADER_STRIKE = RETRIBUTION_TALENT_TREE.Talents
...
// Sheath of Light - Row 8, Column 2
 const SHEATH_OF_LIGHT = RETRIBUTION_TALENT_TREE.Talents
...
// Righteous Vengeance - Row 9, Column 1
 const RIGHTEOUS_VENGEANCE = RETRIBUTION_TALENT_TREE.Talents
...
// Divine Storm - Row 10, Column 1
 const DIVINE_STORM = RETRIBUTION_TALENT_TREE.Talents
