...
export const PROTECTION_TALENT_TREE = PALADIN_CLASS.TalentTrees.get()[1]
...
export const DIVINITY = PROTECTION_TALENT_TREE.Talents
...
export const DIVINE_STRENGTH = PROTECTION_TALENT_TREE.Talents
...
export const STOICISM = PROTECTION_TALENT_TREE.Talents
...
export const GUARDIANS_FAVOR = PROTECTION_TALENT_TREE.Talents
    .addGet("default", "guardians-favor")
    .Position.set(1, 1)

GUARDIANS_FAVOR.Spells.add([20174, 20175]) // 2 ranks

// Anticipation - Row 1, Column 2
export const PROTECTION_ANTICIPATION = PROTECTION_TALENT_TREE.Talents
...
export const DIVINE_SACRIFICE = PROTECTION_TALENT_TREE.Talents
...
export const IMPROVED_RIGHTEOUS_FURY = PROTECTION_TALENT_TREE.Talents
...
export const PROTECTION_TOUGHNESS = PROTECTION_TALENT_TREE.Talents
...
export const DIVINE_GUARDIAN = PROTECTION_TALENT_TREE.Talents
...
export const IMPROVED_HAMMER_OF_JUSTICE = PROTECTION_TALENT_TREE.Talents
...
export const IMPROVED_DEVOTION_AURA = PROTECTION_TALENT_TREE.Talents
...
export const BLESSING_OF_SANCTUARY = PROTECTION_TALENT_TREE.Talents
...
export const RECKONING = PROTECTION_TALENT_TREE.Talents
...
export const SACRED_DUTY = PROTECTION_TALENT_TREE.Talents
...
export const ONE_HANDED_WEAPON_SPECIALIZATION = PROTECTION_TALENT_TREE.Talents
...
export const SPIRITUAL_ATTUNEMENT = PROTECTION_TALENT_TREE.Talents
...
export const HOLY_SHIELD = PROTECTION_TALENT_TREE.Talents
...
export const ARDENT_DEFENDER = PROTECTION_TALENT_TREE.Talents
...
export const REDOUBT = PROTECTION_TALENT_TREE.Talents
...
export const COMBAT_EXPERTISE = PROTECTION_TALENT_TREE.Talents
...
export const TOUCHED_BY_THE_LIGHT = PROTECTION_TALENT_TREE.Talents
...
export const AVENGERS_SHIELD = PROTECTION_TALENT_TREE.Talents
...
export const GUARDED_BY_THE_LIGHT = PROTECTION_TALENT_TREE.Talents
...
export const SHIELD_OF_THE_TEMPLAR = PROTECTION_TALENT_TREE.Talents
...
export const JUDGEMENTS_OF_THE_JUST = PROTECTION_TALENT_TREE.Talents
...
export const HAMMER_OF_THE_RIGHTEOUS = PROTECTION_TALENT_TREE.Talents
